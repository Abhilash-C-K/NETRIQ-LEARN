from backend.ai.contracts import TrafficType, RiskCategory, Action, PredictionResult, FusedPredictionResult
...
from backend.ai.fusion_engine import FusionEngine, fuse
