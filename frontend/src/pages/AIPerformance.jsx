...
import { Cpu, Zap, Activity, ShieldCheck, Sparkles, BarChart2 } from 'lucide-react';
...
export const AIPerformance = () => {
  return (
    <div className="space-y-6">
      ...
      {/* Featured Fluid Blob Card */}
      <BlobCard
        headerHeight={180}
        glowColors={["#06b6d4", "#3b82f6", "#8b5cf6", "#ec4899", "#06b6d4"]}
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 text-white">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-mono font-bold tracking-wide">
                  Dual-Layer Fusion Engine Metrics
                </h2>
              </div>
              <p className="text-xs text-slate-200/80 font-sans max-w-lg">
                Combines 71 flow statistics with SHAP TreeExplainer feature attribution for sub-15ms inference latency.
              </p>
            </div>
            <div className="flex items-center gap-3">
              <div className="text-right">
                <p className="text-[10px] font-mono uppercase text-cyan-200">Average Hot Path Latency</p>
                <p className="text-xl font-mono font-bold text-white">11.4 ms</p>
              </div>
            </div>
          </div>
        }
      >
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-2">
          ...
          <div className="p-4 rounded-xl bg-slate-950/60 border border-slate-800 space-y-1">
            ...
            <p className="text-base font-bold font-mono text-purple-400">Isolation Forest</p>
          ...
          <div className="p-4 rounded-xl bg-slate-950/60 border border-slate-800 space-y-1">
            ...
            <p className="text-base font-bold font-mono text-amber-400">SHAP TreeExplainer</p>
